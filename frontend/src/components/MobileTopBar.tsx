...
const MobileTopBar = ({ dept, name, title, back, buttonOn }: MobileTopBarProps) => {
  ...
  return (
    <div className="fixed top-0 left-0 px-10 z-9999 flex flex-row justify-between items-center w-[393px] h-20 bg-white shadow-[0px_2px_2px_0px_rgba(0,0,0,0.05)]">
      ...
      <div className="flex flex-col justify-center items-center">
        <button className={`flex flex-row gap-2 ${buttonOn ? 'cursor-pointer' : 'cursor-default'}`} onClick={()=>{buttonOn?navigate('/password'):''}}>
